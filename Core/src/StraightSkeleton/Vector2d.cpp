...
Vector2d Vector2d::operator + (const Vector2d& right) const // Cambiar a const
{
    return Vector2d(X + right.X, Y + right.Y);
}
...
Vector2d Vector2d::operator * (double scalar) const // <-- Añadir esta función
{
    return Vector2d(X * scalar, Y * scalar);
}

bool Vector2d::operator == (const Vector2d& right) const // Cambiar a const
{
...
Vector2d& Vector2d::operator += (const Vector2d& right) // Cambiar a const
{
    this->X += right.X;
    this->Y += right.Y;
    return *this;
