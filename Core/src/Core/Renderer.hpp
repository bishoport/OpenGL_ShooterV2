...
//
//La cámara se actualiza y se configuran las matrices de proyección y vista.
//Asegúrate de que estas matrices estén correctamente configuradas y pasadas a los shaders.
//Geometría Pasada(GBuffer) :
//
//	Se configura y se limpia el GBuffer.
//	Se usa el shader geometryPass y se configuran las matrices de proyección y vista.
//	Los modelos se dibujan en la escena y se desvincula el GBuffer.
//	Renderizado SSAO :
//
//Se configura y limpia el FBO de SSAO.
//Se usa el shader ssao y se configuran los uniformes necesarios, incluyendo la matriz de proyección.
//Se vinculan las texturas necesarias y se renderiza el quad para calcular SSAO.
//Se desvincula el FBO de SSAO.
//Renderizado SSAO Blur :
//
//Se configura y limpia el FBO de SSAO Blur.
//Se usa el shader ssaoBlur y se configura la textura de entrada.
//Se renderiza el quad para aplicar el blur.
//Se desvincula el FBO de SSAO Blur.
//Renderizado de Iluminación :
//
//Se configura y limpia el FBO de iluminación.
//Se usa el shader lightingPass y se configuran las texturas del GBuffer y la textura de SSAO Blur.
//Se configuran las luces y los parámetros globales de la escena.
//Se renderiza el quad para calcular la iluminación.
//Se desvincula el FBO de iluminación.
//Copiado del Buffer de Profundidad :
//
//Se copia el buffer de profundidad del GBuffer al FBO de forward.
//Renderizado Forward :
//
//Se configura y limpia el FBO de forward.
//Se usa el shader debug para renderizar las luces de depuración.
//Se usa el shader text para renderizar los textos.
//Se desvincula el FBO de forward.
//Combinación de Resultados :
//
//Se configura y limpia el FBO final.
//Se usa el shader combinePass y se configuran las texturas de deferred, forward y SSAO Blur.
//Se renderiza el quad para combinar los resultados.
//Se desvincula el FBO final.
//Renderizado en Pantalla :
//
//Se limpia el buffer de color y profundidad.
//Se usa el shader colorQuadFBO y se configura la textura de pantalla.
//Se renderiza el quad para mostrar el resultado final en pantalla.